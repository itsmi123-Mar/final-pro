...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['place_order'])) {
    if (!empty($_SESSION['cart'])) {
        ...
        $order_type = $_POST['order_type'] ?? 'In-Store'; // optional
        ...
        // Store order type in session for the thank you page
        $_SESSION['order_type'] = $order_type;
        $_SESSION['cart'] = [];
        
        header("Location: order_status.php?order_id=" . urlencode($order_group_id));
        exit;
    }
}
